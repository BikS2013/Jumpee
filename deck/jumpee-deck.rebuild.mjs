#!/usr/bin/env node
// jumpee-deck.rebuild.mjs — rebuild "jumpee-deck.html" with the current NBG Design editing tools.
//
// Written by the nbg-design skill (scripts/write-rebuild-script.mjs) on 2026-09-15,
...
//
//   node jumpee-deck.rebuild.mjs                 # rebuild the deck next to this script and its PDF
//   node jumpee-deck.rebuild.mjs --check         # only report whether the deck's editor is current (writes nothing)
//   node jumpee-deck.rebuild.mjs --no-pdf        # rebuild the HTML only
//   node jumpee-deck.rebuild.mjs --pdf out.pdf   # rebuild and export the PDF to this path
//   node jumpee-deck.rebuild.mjs other.html      # rebuild another copy of the deck (e.g. the "-edited" copy)
//   node jumpee-deck.rebuild.mjs --no-backup     # do not keep a copy of the deck as it was before
//
